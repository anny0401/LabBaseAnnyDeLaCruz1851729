USE [master]
GO
/****** Object:  Database [Ejemplo1]    Script Date: 12/02/2020 09:56:56 a. m. ******/
CREATE DATABASE [Ejemplo1]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Ejemplo1', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\Ejemplo1.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Ejemplo1_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\Ejemplo1_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
GO
ALTER DATABASE [Ejemplo1] SET  ENABLE_BROKER 
GO
...
GO
ALTER DATABASE [Ejemplo1] SET RECOVERY FULL 
GO
...
GO
EXEC sys.sp_db_vardecimal_storage_format N'Ejemplo1', N'ON'
GO
